...
If you want to try it get it from the Play Store or directly from GitHub https://github.com/greenaddress/abcore/releases/tag/v0.24alphaPoC
...
The dependencies are fetched from either a Debian or Arch mirror (both providing Bitcoin Core 0.11.2) and the node is meant to be used as a personal node when on the go.
